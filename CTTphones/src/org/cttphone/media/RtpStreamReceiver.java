...
package org.cttphone.media;

import java.io.IOException;
import java.net.SocketException;

import org.cttphone.net.RtpPacket;
import org.cttphone.net.RtpSocket;
import org.cttphone.net.SipdroidSocket;
import org.cttphone.sipua.R;
import org.cttphone.sipua.UserAgent;
import org.cttphone.sipua.ui.InCallScreen;
import org.cttphone.sipua.ui.Receiver;
import org.cttphone.sipua.ui.Sipdroid;
import org.cttphone.codecs.Codecs;
...
public class RtpStreamReceiver extends Thread {
	...
	public static synchronized void ringback(boolean ringback) {
		if (ringback && ringbackPlayer == null) {
			...
			setMode(speakermode);
			enableBluetooth(PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.cttphone.sipua.ui.Settings.PREF_BLUETOOTH,
					org.cttphone.sipua.ui.Settings.DEFAULT_BLUETOOTH));
			...
			ringbackPlayer = new ToneGenerator(stream(),(int)(ToneGenerator.MAX_VOLUME*2*org.cttphone.sipua.ui.Settings.getEarGain()));
	...
	void restoreVolume() {
		...
		case AudioManager.MODE_IN_CALL:
				...
				if (oldring > 0) setStreamVolume(AudioManager.STREAM_RING,(int)(
						...
						org.cttphone.sipua.ui.Settings.getEarGain()*3), 0);
				track.setStereoVolume(AudioTrack.getMaxVolume()*
						(ogain = org.cttphone.sipua.ui.Settings.getEarGain()*2)
						,AudioTrack.getMaxVolume()*
						org.cttphone.sipua.ui.Settings.getEarGain()*2);
	...
	void saveSettings() {
		if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.cttphone.sipua.ui.Settings.PREF_OLDVALID, org.cttphone.sipua.ui.Settings.DEFAULT_OLDVALID)) {
			...
			if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).contains(org.cttphone.sipua.ui.Settings.PREF_OLDVIBRATE2))
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putInt(org.cttphone.sipua.ui.Settings.PREF_OLDVIBRATE, oldvibrate);
			edit.putInt(org.cttphone.sipua.ui.Settings.PREF_OLDVIBRATE2, oldvibrate2);
			edit.putInt(org.cttphone.sipua.ui.Settings.PREF_OLDPOLICY, oldpolicy);
			edit.putInt(org.cttphone.sipua.ui.Settings.PREF_OLDRING, am.getStreamVolume(AudioManager.STREAM_RING));
			edit.putBoolean(org.cttphone.sipua.ui.Settings.PREF_OLDVALID, true);
			edit.commit();
		}
	}
	...
	public static void setMode(int mode) {
		Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
		edit.putBoolean(org.cttphone.sipua.ui.Settings.PREF_SETMODE, true);
		edit.commit();
		AudioManager am = (AudioManager) Receiver.mContext.getSystemService(Context.AUDIO_SERVICE);
		if (Integer.parseInt(Build.VERSION.SDK) >= 5) {
	...
	public static void restoreMode() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.cttphone.sipua.ui.Settings.PREF_SETMODE, org.cttphone.sipua.ui.Settings.DEFAULT_SETMODE)) {
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(org.cttphone.sipua.ui.Settings.PREF_SETMODE, false);
			edit.commit();
	...
	public static void restoreSettings() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.cttphone.sipua.ui.Settings.PREF_OLDVALID, org.cttphone.sipua.ui.Settings.DEFAULT_OLDVALID)) {
			...
			int oldvibrate = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(org.cttphone.sipua.ui.Settings.PREF_OLDVIBRATE, org.cttphone.sipua.ui.Settings.DEFAULT_OLDVIBRATE);
			int oldvibrate2 = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(org.cttphone.sipua.ui.Settings.PREF_OLDVIBRATE2, org.cttphone.sipua.ui.Settings.DEFAULT_OLDVIBRATE2);
			int oldpolicy = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(org.cttphone.sipua.ui.Settings.PREF_OLDPOLICY, org.cttphone.sipua.ui.Settings.DEFAULT_OLDPOLICY);
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(org.cttphone.sipua.ui.Settings.PREF_OLDVALID, false);
			edit.commit();
	...
	public void run() {
		boolean nodata = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.cttphone.sipua.ui.Settings.PREF_NODATA, org.cttphone.sipua.ui.Settings.DEFAULT_NODATA);
		keepon = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.cttphone.sipua.ui.Settings.PREF_KEEPON, org.cttphone.sipua.ui.Settings.DEFAULT_KEEPON);
		...
		ToneGenerator tg = new ToneGenerator(AudioManager.STREAM_VOICE_CALL,(int)(ToneGenerator.MAX_VOLUME*2*org.cttphone.sipua.ui.Settings.getEarGain()));
		track.play();
		System.gc();
		empty();
		lockFirst = true;
