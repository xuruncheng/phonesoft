...
{  
   ...
   {  log=logger;
      ...
      try
      {
    	 ...
    	 if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.cttphone.sipua.ui.Settings.PREF_CALLRECORD,
					org.cttphone.sipua.ui.Settings.DEFAULT_CALLRECORD))
