package org.cttphone.sipua.phone;
...
import org.cttphone.sipua.ui.Caller;
                ...
                // First, see if we need to query.
 {
    ...
    private void updateDisplayForPerson(CallerInfo info,
        ...
        if (info != null) 
            ...
            // an unknown contact.
        	  // if (info.phoneNumber.startsWith("1") && info.phoneNumber.length() < 7) 
        	   					//{
        		   //  info.phoneNumber = Caller.pre_fix + info.phoneNumber;
        	   					//}
